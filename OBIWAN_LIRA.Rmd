...
#"BW_diff"     "BMI_diff"       "X2.AG_diff"   "reelin_diff"   "MCP_diff"   "TNFalpha_diff"  "GLP_diff"    "Glu_diff"  
...
#PES.weight[1,]
```
```{r message = FALSE, echo=FALSE, results='hide', fig.show="hold", out.width="25%", fig.align="center", fig.cap = 'Model assumptions.'}
...
\
\
```{r HED_fmri_plot, echo=FALSE,  message=FALSE, cache=TRUE, fig.align="right", fig.cap="Beta estimates from hippocampal formation during Hedonic reactivity test (Post > Pre) by intervention and correlation with weight loss."}
...
```
\
```{r HED_fmri_plot_HF, echo=FALSE,  message=FALSE, cache=TRUE, fig.align="right", fig.cap="Beta estimates from hippocampal formation during Hedonic reactivity testby session by intervention."}
# AVERAGED EFFECT -------------
