...
pltpre = pp + averaged_theme + theme(axis.text.x= element_text(size = 14), axis.text.y= element_text(size = 14), legend.position='none', plot.title = element_text(hjust = 0.5, size = 20), plot.margin = unit(c(0, 1,-1.5,-2), "cm"))
#-------------------------------POST
