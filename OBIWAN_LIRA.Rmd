...
# LRT_spline = PBmodcomp(fmod_full, fmod_spline, nsim = 500, seed = 123, cl=cl)
...
#### Plot {-}
```{r INST_plot, echo = F, results='hide', warning=FALSE, message=FALSE, cache=F, fig.cap="Number of grips over trials by session."}
...
# # p-value from bootstrap distribution
# LRT_cond = PBmodcomp(fmod_full, fmod_cond, nsim = 500, seed = 123, cl=cl) 
...
```{r PIT_plot, warning=FALSE,  message = FALSE, results='hide', fig.align="center", fig.cap="A) Posterior distribution by group. B) Highest density interval (90% HDI) for the interaction condition by sessioon"}
